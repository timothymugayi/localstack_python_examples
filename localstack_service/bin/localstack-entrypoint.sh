...
aws --endpoint-url=$LOCALSTACK_S3_URL s3 sync /tmp/localstack/taxi_data "s3://nyc-tlc/trip data" --cli-connect-timeout 6000 --exclude "*" --include "yellow_tripdata_2018-04_*"
